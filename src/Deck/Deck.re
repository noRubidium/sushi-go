...
module Make = (Nigiri1: Nigiri.S, Nigiri2: Nigiri.S, Nigiri3: Nigiri.S, Special1: Special.S) => {
    type t = 
    | Nigiri1(Nigiri1.t)
    | Nigiri2(Nigiri2.t)
    | Nigiri3(Nigiri3.t)
    ...
    (Special1.getNewSortedDeck()
    |> ListLabels.map(~f=t => Special1(t))), 
    ]
    |> List.concat;

    let score = (pCtx, gCtx, t) => switch(t) {
    ...
    let updateGameContext = (gCtx, t) => switch(t) {
    ...
    let updatePlayerContext = (pCtx, t) => switch(t) {
